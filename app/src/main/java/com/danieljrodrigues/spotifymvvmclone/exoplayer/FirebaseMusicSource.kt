package com.danieljrodrigues.spotifymvvmclone.exoplayer

import android.support.v4.media.MediaBrowserCompat
import android.support.v4.media.MediaDescriptionCompat
import android.support.v4.media.MediaMetadataCompat
import androidx.core.net.toUri
import com.danieljrodrigues.spotifymvvmclone.data.remote.MusicDatabase
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO) {
        ...
        songs = allSongs.map { song ->
            MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_DISPLAY_ICON_URI, song.coverUrl)
                .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI, song.songUrl)
                .putString(MediaMetadataCompat.METADATA_KEY_ART_URI, song.coverUrl)
